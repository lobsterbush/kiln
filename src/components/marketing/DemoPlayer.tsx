...
const SCENES: Scene[] = [
  {
    ...
    students: [
      ...
      { name: 'James W.',  initials: 'JW', avatar: 'bg-cyan-100 text-cyan-700',   response: 'Conflates correlation with causation in the electoral systems comparison.' },
  ...
  },
  {
    ...
    students: [
      ...
      { name: 'James W.',  initials: 'JW', avatar: 'bg-cyan-100 text-cyan-700' },
  ...
  },
  {
    ...
    students: [
      ...
      { name: 'James W.',  initials: 'JW', avatar: 'bg-cyan-100 text-cyan-700',  response: "The EU has many veto players but shared preferences, so change happens. Number alone misleads." },
    ],
  },
  {
    ...
    students: [
      ...
      { name: 'Sofia L.',  initials: 'SL', avatar: 'bg-teal-100 text-teal-700' },
      { name: 'James W.',  initials: 'JW', avatar: 'bg-cyan-100 text-cyan-700',  response: 'Electoral systems mediate the relationship — the trend line hides significant variation.' },
  ...
  },
  {
    ...
    students: [
      ...
      { name: 'James W.',  initials: 'JW', avatar: 'bg-cyan-100 text-cyan-700',  turns: [
